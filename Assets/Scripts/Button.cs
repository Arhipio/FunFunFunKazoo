...
public class Button : MonoBehaviour {
	...
	void Start (){
		button = GameObject.Find("Button").getComponent("ButtonPress");
		button2 = GameObject.Find("Button 1").getComponent("ButtonPress2");
		button3 = GameObject.Find("Button 2").getComponent("ButtonPress3");
	}
